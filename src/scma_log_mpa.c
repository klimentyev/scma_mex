        ...
        for(int k = 0; k < K; k++)
        {
            for(int m1 = 0; m1 < M; m1++)
            {
                for(int m2 = 0; m2 < M; m2++)
                {
                    ...
                    {
                        complex_double_t sum = complex_add(complex_add(complex_mult(cb[k][m1][ind_df[k][0]],h[k][ind_df[k][0]][n]), complex_mult(cb[k][m2][ind_df[k][1]],h[k][ind_df[k][1]][n])), complex_mult(cb[k][m3][ind_df[k][2]],h[k][ind_df[k][2]][n]));
